...
public class Grid {
    ...
    public int[] calculateNearestNoiseCell(int i, int j) {
        ...
        boolean[][] visited = new boolean[nrows][ncols]; // ��¼�ѷ��ʵĵ�Ԫ��

        queue.offer(new int[]{i, j}); // ��ʼ��Ԫ�����
        visited[i][j] = true; // ���Ϊ�ѷ���
        ...
        while (!queue.isEmpty()) {
            ...
            if (this.hasCell(curRow, curCol) && this.getCell(curRow, curCol).getNoiseList()) {
                return new int[]{curRow, curCol}; // �ҵ�����ĺ�������Ԫ��
            }
            ...
            for (int k = 0; k < 4; k++) {
                ...
                if (newRow >= 0 && newRow < nrows && newCol >= 0 && newCol < ncols && !visited[newRow][newCol]) {
                    queue.offer(new int[]{newRow, newCol}); // �µ�Ԫ�����
                    visited[newRow][newCol] = true; // ���Ϊ�ѷ���
                }
            }
        }

        return new int[]{-1, -1}; // ���������û�������㣬����[-1, -1]
    }
